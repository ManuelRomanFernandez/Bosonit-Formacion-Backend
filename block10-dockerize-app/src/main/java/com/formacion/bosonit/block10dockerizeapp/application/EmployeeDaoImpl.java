...
import com.formacion.bosonit.block10dockerizeapp.controller.EmployeeRowMapper;
...
public class EmployeeDaoImpl implements EmployeeDao{
    ...
    public void updateEmployee(Employee emp) {
        final String sql = "update employee set employeeName=:employeeName, employeeEmail=:employeeEmail, employeeAddress=:employeeAddress where employeeId=:employeeId";
